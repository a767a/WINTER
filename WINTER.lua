...
SUDO = SUDO
sudo_users = {SUDO,1307427795,1307427795}   
print([[
...
io.popen("cd library && wget https://raw.githubusercontent.com/LARICATEAM/WINTER/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/OO0a0/Files_WINTER/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevWINTERW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevWINTERW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevWINTERW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevWINTERW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevWINTERW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevWINTERW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevWINTERW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "zZvzZo")
...
local WINTER_Msg = ''  
if msgs < 100 then 
WINTER_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
WINTER_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
WINTER_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
WINTER_Msg = 'متفاعل' 
elseif msgs < 1200 then 
WINTER_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
WINTER_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
WINTER_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
WINTER_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
WINTER_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
WINTER_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
WINTER_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
WINTER_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
WINTER_Msg = 'رب التفاعل'  
end 
return WINTER_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceWINTER(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."WINTER1:List:Filter"..sl)
...
if not DevWINTERW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevWINTERW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,WINTER_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌯' and DevWINTERW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevWINTERW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevWINTERW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevWINTERW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevWINTERW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevWINTERW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevWINTERW(msg) then 
...
if text == 'تحديث السورس ⌯' and DevWINTERW(msg) then 
os.execute('rm -rf WINTER.lua')
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/WINTER/main/WINTER.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس شتاء*\n*⌯︙الاصدار » { 2.8v}*')
dofile('WINTER.lua')  
end
if text == 'الاصدار ⌯' and DevWINTERW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس شتاء* \n*⌯︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌯' and DevWINTERW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/OO0a0) \n⌯︙[قناه السورس](t.me/zZvzZo)')
end
if text == "ضع اسم للبوت ⌯" and DevWINTERW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevWINTERW(msg) then 
...
if text == 'المشتركين ⌯' and DevWINTERW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevWINTERW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevWINTERW(msg) then
...
if text == ("قائمه العام ⌯") and DevWINTERW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevWINTERW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevWINTERW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevWINTERW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevWINTERW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevWINTERW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevWINTERW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevWINTERW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevWINTERW(msg) then
...
if text == "تنظيف الكروبات ⌯" and DevWINTERW(msg) then 
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..WINTERk..''..WINTER..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevWINTERW(msg) then
...
usertext = '*\n ⌯︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'zZvzZo')..')'
status  = '\n *⌯︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevWINTERW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'zZvzZo')..')'
status  = '\n*⌯︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevWINTERW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevWINTERW(msg) then
...
local WINTER1_Msg = database:get(bot_id.."WINTER1:Add:Filter:Rp2"..text..msg.chat_id_)   
if WINTER1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'zZvzZo')..') \n ⌯︙'..WINTER1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if WINTER_Msg and not Special(msg) then  
local WINTER_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if WINTER_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..WINTER_Msg.."] \n")
else
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/zZvzZo)}\n⌯︙["..WINTER_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⌯︙عذرا ↫* {["..data.first_name_.."](T.ME/zZvzZo)}\n*⌯︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevWINTERW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevWINTERW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevWINTERW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevWINTERW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevWINTERW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevWINTERW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevWINTERW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevWINTERW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevWINTERW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."WINTER:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."WINTER:blocname"..msg.chat_id_)
...
functionBBPBa_name(t1,t2)
if t2.id_ then 
name_WINTER = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_WINTER then 
names_WINTER = database:smembers(bot_id.."WINTER:blocname"..msg.chat_id_) or ""
if names_WINTER and names_WINTER[1] then 
for i=1,#names_WINTER do 
if name_WINTER:match("(.*)("..names_WINTER[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_,BBPBa_name)
end
...
database:set(bot_id.."WINTER:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."WINTER:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."WINTER:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."WINTER:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."WINTER:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_WINTERa_new(WINTER1,WINTER2)
if WINTER2 and WINTER2.first_name_ then 
if WINTER2.first_name_:match("(.*)"..database:get(bot_id.."WINTER:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."WINTER:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local WINTER_nnn = database:get(bot_id.."WINTER:nump"..msg.chat_id_) or 5
local WINTER_nnn2 = database:get(bot_id.."WINTER:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(WINTER_nnn2) == tonumber(WINTER_nnn) or tonumber(WINTER_nnn2) > tonumber(WINTER_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."WINTER:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..WINTER2.username_.."](https://t.me/"..(WINTER2.username_ or "zZvzZo")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."WINTER:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(WINTER_nnn) - tonumber(WINTER_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_WINTERa_new)
end
end
...
local WINTERChengName = database:get(bot_id.."WINTER:Cheng:Name"..data.id_)
if not data.first_name_ then 
if WINTERChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..WINTERChengName..']')
database:del(bot_id.."WINTER:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if WINTERChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."WINTER:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local WINTERChengUserName = database:get(bot_id.."WINTER:Cheng:UserName"..data.id_)
if not data.username_ then 
if WINTERChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..WINTERChengUserName..']')
database:del(bot_id.."WINTER:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if WINTERChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."WINTER:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local WINTERChengPhoto = database:get(bot_id.."WINTER:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if WINTERChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."WINTER:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if WINTERChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."WINTER:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local url,res = https.request('https://vvvzvv.ml/apiWINTER/WINTER.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'⌯︙شترك في قناة السورس اولآ @OO0a0 .')
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ᴡɪɴᴛᴇʀ\n\n[⌯  ᴡɪɴᴛᴇʀ ᴄʜᴀɴɴᴇʟ](http://t.me/OO0a0)\n\n[⌯  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/zZvzZo)\n\n[⌯  ᴡɪɴᴛᴇʀ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/VVVZVV)\n\n[⌯  ʙᴏᴛ ᴡɪɴᴛᴇʀ](http://t.me/s7DaBot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ sᴏᴜʀᴄʀ ᴡɪɴᴛᴇʀ',url="t.me/OO0a0/3"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'رفع نسخه الاحتياطيه' and DevWINTERW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*⌯︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'zZvzZo')..') \n*⌯︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'zZvzZo')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevWINTERW(msg) then
dofile('WINTER.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevWINTERW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevWINTERW(msg) then  
function start_function(extra, result, success)
if WINTERSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevWINTERW(msg) then  
...
if WINTERSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevWINTERW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if WINTERSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevWINTERW(msg) then  
function start_function(extra, result, success)
if WINTERSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevWINTERW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevWINTERW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if WINTERSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevWINTERW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevWINTERW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevWINTERW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevWINTERW(msg) then
...
if text == 'الملفات' and DevWINTERW(msg) then
t = ' *⌯︙ملفات السورس شتاء ↓*\n*•━━━━━━ 𝗡𝗧 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevWINTERW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/OO0a0/Files_WINTER/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⌯︙اهلا بك في متجر ملفات شتاء*\n*⌯︙ملفات السورس ↓*\n*•━━━━━━ 𝗡𝗧 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝗡𝗧 ━━━━━━━•*\n *⌯︙علامة تعني { ✓ } ملف مفعل*\n *⌯︙علامة تعني { ✘ } ملف معطل*\n *⌯︙قناة سورس شتاء ↓*\n".." *⌯︙*[اضغط هنا لدخول](t.me/zZvzZo) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevWINTERW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/OO0a0/Files_WINTER/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('WINTER.lua')  
else
send(msg.chat_id_, msg.id_," *⌯︙عذرا الملف لايدعم سورس شتاء* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevWINTERW(msg) then
...
if text == "مسح الملفات" and DevWINTERW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevWINTERW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevWINTERW(msg) then  
function start_function(extra, result, success)
...
local UserName = (b.username_ or "zZvzZo")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'zZvzZo')..')'
status  = '\n*⌯︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'zZvzZo')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'zZvzZo')..')'
...
database:set(bot_id.."WINTER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."WINTER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."WINTER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."WINTER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."WINTER1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."WINTER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."WINTER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."WINTER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."WINTER1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."WINTER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌯︙ارسل الكلمه الان*")  
database:set(bot_id.."WINTER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."WINTER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."WINTER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."WINTER1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."WINTER1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."WINTER1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."WINTER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."WINTER1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."WINTER1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevWINTERW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevWINTERW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'zZvzZo')..')'..'\n*⌯︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevWINTERW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevWINTERW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'شتاء').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'شتاء')
local WINTER_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..WINTER_Msg[math.random(#WINTER_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevWINTERW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,WINTER)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝗡𝗧 ━━━━━━━•*\n"
x = 0
local list = WINTER.members_
for k, v in pairs(list) do
x = x + 1
...
if WINTERSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevWINTERW(msg) then 
...
if text == ("ردود المطور") and DevWINTERW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ 𝗡𝗧 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevWINTERW(msg) then    
send(msg.chat_id_, msg.id_,' *⌯︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevWINTERW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'شتاء').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevWINTERW(msg) then   
...
if text == 'تعطيل المغادره' and DevWINTERW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'zZvzZo')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
WINTERdx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevWINTERW(msg) then
...
{{text = '𝑇𝐸𝐿𝐴𝑁𝐷 𝑇𝐸𝐴𝑀', url="t.me/OO0a0"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
zh = https.request('https://vvvzvv.ml/amirZhfa/WINTER.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⌯︙قائمه الزخرفه* \nٴ⌯∫ٴ*•━━━━━━ 𝗡𝗧 ━━━━━━━•*ٴ⌯∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ⌯∫ٴ*•━━━━━━ 𝗡𝗧 ━━━━━━━•*ٴ⌯∫○ٴ\n⌯︙[𝑇𝐸𝐿𝐴𝑁𝐷 𝑇𝐸𝐴𝑀](t.me/zZvzZo) ')
end
...
gk = https.request('https://vvvzvv.ml/amirBrg/WINTER.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/WINTER.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/WINTER.php')
if res == 200 then
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴡɪɴᴛᴇʀ',url='http://t.me/OO0a0'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'شتاء')
...
WINTER = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(WINTER)
...
--------------------------------------------------------------------------------------------------------------
SourceWINTER(data.message_,data)
...
------------------------------------------------------------------------
local WINTERAbot = database:get(bot_id.."WINTER1:Add:Filter:Rp2"..text..result.chat_id_)   
if WINTERAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..WINTERAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local WINTER1_Msg = database:get(bot_id.."WINTER1:Add:Filter:Rp2"..text..result.chat_id_)   
if WINTER1_Msg then
send(msg.chat_id_, msg.id_," ⌯︙"..WINTER1_Msg)
